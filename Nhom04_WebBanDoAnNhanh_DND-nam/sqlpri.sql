...
-- Thời gian đã tạo: Th8 12, 2024 lúc 02:36 PM
...
CREATE TABLE `bill` (
  ...
  `bill_status` varchar(50) NOT NULL DEFAULT '0' COMMENT 'tình trạng hóa đơn',
...
(6, 'Cơm rang cà chua', 'Nguyên liệu gồm :\r\n1 tô cơm ( tô canh)\r\n100gr lạp xưởng\r\n6 quả trứng gà\r\n200gr đậu que\r\nCà rốt, tỏi\r\nGia vị: Nước mắm, nước tương, bột ngọt, tiêu', 'com_rang_ca_chua.png', 15000, 30000, 20000, 999999, 2),
(7, 'Cơm trưa đầy đủ', 'Nguyên liệu gồm :\r\n 1 tô cơm ( tô canh) 200gr thịt bò 3 quả trứng gà 100gr rau cải Cà rốt, tỏi Gia vị: Nước mắm, nước tương, bột ngọt, tiêu', 'Com_trua_day-du.jpg', 18000, 35000, 35000, 999999, 2),
(8, 'Cơm gà rán', 'Nguyên liệu gồm: \r\nGạo 250 gr\r\n(1 lon)\r\n Đùi gà 1 cái\r\n(350gr)\r\n Hành tây 1/2 củ\r\n Dầu ăn 50 ml\r\n Bột nghệ 1.5 muỗng cà phê\r\n Muối/ Hạt nêm 1 ít', 'com_trua_ga_ran.jpg', 18000, 25000, 25000, 9999999, 2),
(9, 'Cơm gà cải xoăn', 'Nguyên liệu gồm:\r\n1/2 miếng thịt ức gà không lấy da, xắt sợi cỡ ngón tay\r\n4 lá cải xoăn tước bỏ cọng, xé miếng\r\n3 quả trứng gà\r\n3 chén cơm\r\nGia vị: dầu olive, hạt nêm, nước mắm, bột ngọt, đường, tiêu, ớt', 'com_trung_cai_xoan.png', 15000, 30000, 30000, 999999999, 2),
(10, 'Cơm gà sốt cà ri cải Kale', 'Thành phần gồm:\r\n1/2 miếng thịt ức gà không lấy da, xắt sợi cỡ ngón tay\r\n4 lá cải Kale tước bỏ cọng, xé miếng\r\n3 quả trứng gà\r\n3 chén cơm\r\n4 muỗng canh sốt cà ri\r\nGia vị: dầu olive, hạt nêm, nước mắm, bột ngọt, đường, tiêu, ớt', 'cơm-ga-sốt-ca-ri-với-cải-kale-recipe-step-7-photo.webp', 15000, 30000, 30000, 100000000, 2),
(11, 'Bánh bofcowm nguội', 'Nguyên liệu gồm:\r\n90gr cơm nguội\r\n180gr bột gạo\r\n120ml nước dừa tươi\r\n40ml nước cốt dừa\r\n20ml nước ấm\r\n70gr đường\r\n2gr men', 'banh_bo_com_nguoi_doc_dao_moi.jpg', 14999, 20000, 20000, 99999999, 2),
(12, 'bánh rán từ cơm nguội', 'Nguyên liệu:\r\n1 chén cơm nguội\r\n30g thịt bằm chay\r\nHành tím, ớt, mè trắng rang\r\nGia vị: Đường, hạt nêm chay, tương ớt, dầu ăn, nước mắm chay', 'banh_gao_com_nguoi_voi_me_den.jpg', 15000, 20000, 20000, 9999999, 2),
(13, 'Cơm chiên tôm xúc xích', 'Nguyên liệu gồm: \r\nCơm nguội để tủ lạnh qua đêm\r\nTrứng gà\r\nTỏi xay\r\nSpam\r\nTôm lột vỏ\r\nMăng tây\r\nHành lá\r\nDầu hào\r\nNước tương\r\nGia vị (đường, tiêu, hạt nêm)', 'cơm-chien-cho-bữa-trưa-nhanh-gọn-recipe-main-photo.webp', 15000, 25000, 25000, 100000000, 2),
(14, 'Cơm rang dưa bò', 'Nguyên liệu gồm:\r\n300 gram thịt bò\r\n1-2 quả cà chua\r\n1 bát dưa cải chua\r\n2-3 bát cơm nguội\r\n2 quả trứng\r\n1 mẩu cà rốt\r\n4 củ hành khô to\r\n1 củ tỏi\r\n1 thìa dầu hào\r\n2 thìa mắm ngon\r\n1 thìa bột nêm\r\n1 nhúm tiêu xay\r\n1 bát con dầu ăn', 'cơm-rang-dưa-bo-cơm-trưa-vp-recipe-main-photo.webp', 15000, 30000, 30000, 9999999, 2),
(15, 'Cơm chiên hạt điều', 'Nguyên liệu gồm: \r\n1 tô cơm nguội\r\n1 nắm hạt điều vụn hoặc vỡ đôi\r\n10 cái nấm bào ngư (nấm sò)\r\n1 cây cải kale\r\nĐậu hũ Nhật (không bắt buộc)\r\nHạt nêm chay', 'cơm-chien-hạt-diều-recipe-main-photo.webp', 15000, 25000, 25000, 100000000, 2),
(16, 'Cơm cá lóc cải xoăn', 'Nguyên liệu gồm:\r\nRau cải xoăn\r\nCá lóc thái bỏ xương\r\nHành tím băm nhuyễn', 'cơm-ca-loc-cải-xoan-recipe-main-photo.webp', 15000, 25000, 25000, 999999, 2),
(17, 'Cơm Tấm Chay', 'Nguyên liệu gồm:\r\nTấm\r\n500 gr tấm thơm\r\n5 gr dầu ăn\r\n420 gr nước\r\nNước mắm cơm tấm\r\n150 gr nước mắm chay\r\n283 gr đường\r\n8.3 gr muối\r\n150 gr nước lọc\r\nĐồ chua\r\n30 gr cà rốt\r\n150 gr củ cải trắng\r\n40 gr đường\r\n3 gr muối\r\n15 gr giấm\r\nDưa rau muống\r\n300 gr rau muống\r\n30 gr tỏi\r\n10 gr ớt\r\n30 gr hành tím\r\n50 gr đường\r\n30 gr giấm\r\n60 gr nước lọc\r\nBì chay\r\n2 vắt miến\r\n15 gr thính\r\n40 gr đậu hủ chiên\r\n10 gr hủ ki chiên\r\n5 gr tỏi phi\r\n2 gr muối\r\n5 gr đường\r\n1 gr bột ngọt\r\n5 gr hạt nêm\r\nChả chay\r\n1 hộp đậu hủ non\r\n50 gr đậu gà\r\n60 gr bánh mì\r\n60 gr sữa đậu nành\r\n150 gr thịt xay chay\r\n30 gr nấm mèo\r\n20 gr hành lá\r\n20 gr hành tím\r\n20 gr tỏi\r\n30 gr dầu ăn\r\n8 gr hạt nêm\r\n3 gr bột ngọt\r\n3 gr dầu mè\r\n5 gr dầu điều', 'cơm-tấm-chay-recipe-main-photo.webp', 15000, 30000, 30000, 100000000, 2),
(18, 'Cơm chiên xanh', 'Nguyên liệu gồm:\r\nCồi sò điệp\r\nTôm (em thay bằng càng ghẹ)\r\nBắp ngọt, đậu ve, ớt chuông, cà rốt\r\nBột cải kale', 'cơm-chien-xanh-recipe-main-photo.webp', 15000, 30000, 30000, 100000000, 2),
(19, 'Cơm chiên Hải sản xanh', 'Nguyên liệu gồm:\r\n 30p\r\n Em bé/người lớn\r\nCơm nấu chín để nguội\r\n1 con mực\r\n1-2 con tôm sơ chế sạch\r\nRau cải kale hoặc bó xôi\r\n1 mẩu nhỏ Carrot\r\nHành, tỏi\r\nBột hành\r\nGia vị (hạt nêm/tương)\r\nDầu ăn', 'cơm-chien-hải-sản-xanh-recipe-main-photo.webp', 15000, 30000, 30000, 100000000, 2),
(20, 'Cơm rang keto', 'Nguyên liệu gồm: \r\nSúp lơ trắng. Cà rốt. Lá hẹ hoặc hành. Hành tây.\r\n1 ít Giò chả hoặc xúc xích (giò chả xúc xích tất cả đều mình tự làm mình mới ăn chứ ko mua ngoài. Ai ko tự làm dc thì nên ăn ít đồ mua sẵn thôi ạ,)\r\nMắm muối tiêu', 'cơm-rang-keto-danh-cho-những-bạn-dang-giảm-can-như-tớ-recipe-main-photo.webp', 15000, 25000, 25000, 100000000, 2),
(21, 'Cơm gà nướng mật ong ', 'Nguyên Liệu\r\n1 con gà tầm 1 kg rưỡi\r\nCơm trắng hoặc chiên\r\nKetchup, mật ong,dầu hào, muối,xì dầu,bột nêm\r\nĐồ chua cà rốt làm chua ngọt hoặc dưa leo,cà chua,xà lách\r\n3 củ hành tím', 'cơm-ga-nướng-mật-ong-recipe-main-photo.webp', 15000, 35000, 35000, 99999999, 2),
(22, 'Cơm gạo chiên hạt sen', 'Nguyên Liệu\r\n 40 phút\r\n 1 phần ăn\r\nCơm gạo lứt hạt sen rau củ\r\n25 g gạo lứt đồ Simply\r\n25 g hạt sen\r\n25 g cà rốt thái sợi\r\n25 g bắp vàng tách hạt\r\nỨc gà xào cải thìa và nấm đông cô\r\n75 g ức gà\r\n15 g nấm hương khô\r\n50 g cải thìa\r\nGia vị: dầu hào, hạt nêm', 'com_ga_gao.jpg', 15000, 30000, 30000, 9999999, 2),
(24, 'Khoai Tây Chiên', 'Ngon, giòn', 'khoaitay.jpg', 15000, 35000, 35000, 100000000, 13),
(25, 'Burger', 'ngon, béo', 'burger.jpg', 15000, 35000, 35000, 100000000, 13),
(26, 'Gà Rán', 'gà rán trong mềm ngoài ròn trẻ em rất thích', 'ga-ran-nha-trang-banner.jpg', 20000, 45000, 45000, 100000000, 13),
(27, 'Pizza', 'Pizza chuẩn của Ý', 'pizza.jpg', 22000, 50000, 50000, 100000000, 13),
(28, 'Gà Xốt Cay', 'Gà được rán trong dầu ở nhiệt độ cao rồi sau đó được tẩm sốt cay', '1.jpg', 15000, 50000, 50000, 100000000, 13),
(29, 'Chân Gà Xả Tắc', 'Chân gà xốt Thái là món ăn vặt được nhiều người yêu thích nhờ vị chua, cay kích thích vị giác. Cách làm chân gà xốt Thái rất đơn giản, bạn chỉ cần có một vài bí quyết nhỏ là đã có thể hoàn chỉnh hương vị cho món ăn này. Bài viết dưới đây sẽ chia sẻ đến bạn tuyệt chiêu làm xiêu lòng người dùng với món chân gà xốt Thái.\r\n Để có được món ăn ngon, việc đầu tiên bạn cần làm là phải chọn được nguyên liệu tươi. Đối với món chân gà xốt Thái, nguyên liệu tươi ngon rất quan trọng quyết định phần lớn hương vị và chất lượng. Dưới đây sẽ là một số mẹo để giúp bạn chọn được chân gà tươi ngon.', '2.jpg', 15000, 20000, 30000, 100000000, 13),
(30, 'Nem Chua Rán', 'Vào những buổi xế chiều, rất dễ để bắt gặp hình ảnh những bạn trẻ Hà Nội tụm năm tụm ba ở những quán cóc. Chỉ với một đĩa nem chua rán và vài cốc trà chanh, các bạn có thể ngồi hàng giờ bên nhau, chia sẻ hay “chém gió” về những dự định trong công việc và cuộc sống.\r\n\r\nNếu không muốn la cà nơi quán xá mà vẫn có thể thưởng thức món ăn thơm ngon này thì hãy lập team, rủ hội chị em bạn gì qua cùng thực hiện món nem chua rán. Chỉ cần bỏ ra một ít thời gian và công sức, bạn đã có ngay “mồi nhậu” hấp dẫn rồi! Tham khảo và thực hiện ngay nhé!', '3.jpg', 15000, 25000, 25000, 100000000, 13),
(31, 'Khoai Lang Kén', 'Trong thế giới ẩm thực đa dạng, khoai lang kén là một trong những món ăn vặt được ưa chuộng nhất bởi hương vị thơm ngon và màu sắc hấp dẫn. Hãy theo dõi hướng dẫn trong bài viết này để học cách làm khoai lang kén đơn giản mà ngon miệng nhé! Với hướng dẫn các công thức đa dạng mà Tiki Blog chia sẻ dưới đây, bạn sẽ có thể bắt tay ngay vào chế biến món khoai lang kén theo khẩu vị yêu thích!', '4.jpg', 8000, 20000, 20000, 100000000, 13),
(35, 'coca', 'Nước ngọt có ga béo và nhiều năng nượng', 'coca.webp', 7000, 10000, 10000, 10000, 14),
(36, 'Trà Dâu', 'Tươi mát dâu được nhập từ trên cao nguyên về chất lượng quốc tế', 'dau.jpg', 6000, 25000, 25000, 100, 14),
(37, 'Trà Chanh', 'Tranh xanh tươi mát + mùa hè cảm giác khác biệt đập tan cái nóng', 'nuoc-chanh-16713834667491021630140.webp', 5000, 15000, 15000, 150, 14),
(38, 'BonCha', 'Tươi Mát', 'images.jpg', 7000, 15000, 15000, 200, 14),
(39, 'Trà Đao Cam Xả', 'Cam Tươi cộng xả nhà trồng thanh mát từng giọt', 'tra-dao-cam-sa.jpg.webp', 10000, 25000, 25000, 109, 14),
(40, 'Táo đỏ', 'tươi mát không chất bảo quản', 'tao.jpg', 5000, 20000, 20000, 150, 15),
(41, 'Kem Socola', 'Tươi mát, ngot béo của socola. Socola nhập khẩu châu âu', 'images (1).jpg', 10000, 30000, 30000, 140, 15),
(42, 'Kem Ly Vị Dâu', 'Ngon mát bảo đảm sức khỏe', 'kem-dau-tay-tuoi-khong-bi-dam-da.webp', 10000, 35000, 35000, 120, 15),
(43, 'Bò Khô', 'Để phân biệt thịt bò nguyên chất hay thịt bò khô được làm giả, bà Minh Hằng cho biết, khi quan sát, thịt bò khô thật sẽ có màu vàng sẫm, thớ to. Thịt bò khô giả thường có màu sắc bắt mắt, sợi nhỏ và thớ ngắn. Nếu ngửi, thịt bò khô thật có mùi gây nồng rất đặc trưng của thịt bò. Khi ăn, thịt bò khô thật dai mềm, ngọt thơm và vị cay mặn ngọt hòa quyện một cách vừa phải. Thịt bò khô giả sẽ ít có mùi bò, thường bị tẩm ướp nhiều ớt sả để át mùi. Khi ăn, thịt bò khô giả rất bở, dễ xé, vị thường rất cay và ngọt.', 'kho-bo.jpg', 8000, 15000, 15000, 100, 14),
(44, 'Khô Gà', 'Với món ăn, quan trọng nhất là nguồn nguyên liệu. Nếu thực phẩm đó đã ô nhiễm thì dù có sấy hay chế biến kiểu gì vẫn là thực phẩm ô nhiễm. Nhưng vấn đề thứ hai nguy hiểm hơn là sau khi sấy xong, tưởng thế là đã bảo quản tốt rồi thì thực phẩm khi ấy vẫn có thể nhiễm các loại mốc. Cho nên thực phẩm không rõ nguồn gốc, mà lại được chế biến khô như món khô gà thì về giá trị dinh dưỡng là rất thấp, có nhiều nguy cơ bị nhiễm các loại vi sinh vật, nấm mốc. Một loại thực phẩm ẩn chứa nhiều nguy hại lại không mang lại nhiều giá trị dinh dưỡng, người tiêu dùng nên hạn chế sử dụng đặc biệt là trong mùa dịch bệnh phức tạp như hiện nay. Nếu vẫn có nhu cầu sử dụng thì nên mua ở những nơi rõ nguồn gốc xuất xứ, hoặc có thể tự làm để ăn.', 'ga.jpg', 8000, 15000, 15000, 100, 15),
(45, 'Trà Vải', 'Mùa vải đã đến rồi, bắt ngay trend làm trà thạch vải để giải cứu vải Bắc Giang các bạn nhé!!\r\n\r\nCách làm trà thạch vải vô cùng đơn giản, chỉ cần bỏ chút thời gian là bạn đã có ngay 1 nồi nước to đùng cho cả gia đình giải khát ngày hè rồi đó.', 'tra-vai.jpg', 8000, 25000, 25000, 200, 14),
(46, 'Matcha Đá Xay', 'Trà xanh đá xay (Matcha Ice Blended) là một trong những thức uống giữ được độ “hot” trong thực đơn của các cửa hàng thức uống. Hương vị trà xanh đặc trưng hòa cùng vị sữa, kem tươi béo ngậy tạo nên một thức uống thơm ngon, béo ngậy.', 'matcha-da-xay.webp', 8000, 25000, 25000, 999999, 14),
(47, 'Bánh mì dân tổ', 'Bánh mì dân tổ Hà Nội, trước đây khi muốn thưởng thức, thực khách phải xếp hàng dài chờ đợi trong đêm khuya. Hiện nay, các quán bánh mì dân tổ đã mở cửa cả ngày để bạn có thể cảm nhận sự độc đáo trong hương vị của món bánh này.', 'banh-mi-dan-to-ha-noi-2.jpg', 8000, 20000, 20000, 1000000000, 15);
...
CREATE TABLE `users` (
  ...
  `full_name` varchar(255) NOT NULL,
  `avatar_url` varchar(255) NOT NULL COMMENT 'ảnh user',
...
(1, 'admin@gmail.com', '12345', '0337412617', 'Thanh Mỹ - Sơn Tây - Hà Nội', 'Nguyễn Phương', 'Screenshot 2024-07-11 165115.png', 1, NULL, 'Active'),
...
--
ALTER TABLE `product`
  MODIFY `product_id` int NOT NULL AUTO_INCREMENT COMMENT 'ID sản phẩm', AUTO_INCREMENT=48;
...
ALTER TABLE `cart`
  ...
  ADD CONSTRAINT `cart_ibfk_3` FOREIGN KEY (`bill_id`) REFERENCES `bill` (`bill_id`);
